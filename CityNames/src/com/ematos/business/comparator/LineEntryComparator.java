...
public class LineEntryComparator {
	...
	public static void main(String[] args) {
		...
		List<StringIssue> stringIssue = new ArrayList<StringIssue>();
		stringIssue.add(comparator.compareStrings(correctString, correctString));
		stringIssue.add(comparator.compareStrings(correctString, checkString00));
		stringIssue.add(comparator.compareStrings(correctString, checkString01));
		stringIssue.add(comparator.compareStrings(correctString, checkString02));
		stringIssue.add(comparator.compareStrings(correctString, checkString03));
		stringIssue.add(comparator.compareStrings(correctString, checkString04));
		stringIssue.add(comparator.compareStrings(correctString, checkString05));
		stringIssue.add(comparator.compareStrings(correctString, checkString06));
		stringIssue.add(comparator.compareStrings(correctString, checkString07));
		stringIssue.add(comparator.compareStrings(correctString, checkString08));
		stringIssue.add(comparator.compareStrings(correctString, checkString09));
		stringIssue.add(comparator.compareStrings(correctString, checkString10));
		stringIssue.add(comparator.compareStrings(correctString, checkString11));
		stringIssue.add(comparator.compareStrings(correctString, checkString12));
		stringIssue.add(comparator.compareStrings(correctString, checkString13));
		stringIssue.add(comparator.compareStrings(correctString, checkString14));
		stringIssue.add(comparator.compareStrings(correctString, checkString15));
		stringIssue.add(comparator.compareStrings(correctString, checkString16));
		stringIssue.add(comparator.compareStrings(correctString, checkString17));
		stringIssue.add(comparator.compareStrings(correctString, checkString18));
		stringIssue.add(comparator.compareStrings(correctString, checkString19));
